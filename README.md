...
<br>***Inference:***
```shell
python detect_ort.py --weights runs/train/exp/weights/best.pt --conf 0.25 --img-size 640 --source UWH-6/test/images/DJI_0021_mp4-32_jpg.rf.0d9b746d8896d042b55a14c8303b4f36.jpg
```
